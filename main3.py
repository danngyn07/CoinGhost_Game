...
while running:
    ...
    if not game_over:
        ...
        if keys[pygame.K_RIGHT] and character_rect.centerx <= bg.get_width() - 25:
            character_rect.centerx += character_change_movement_speed
        if keys[pygame.K_LEFT] and character_rect.centerx >= 25:
            character_rect.centerx -= character_change_movement_speed
        if keys[pygame.K_DOWN] and character_rect.centery <= bg.get_height() - 25:
            character_rect.centery += character_change_movement_speed
        if keys[pygame.K_UP] and character_rect.centery >= 25:
            character_rect.centery -= character_change_movement_speed
